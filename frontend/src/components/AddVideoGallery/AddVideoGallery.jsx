...
function AddVideoGallery() {
  ...
  const handleSubmit = (e) => {
    ...
    formData.append("title", gallery.name);
    formData.append("url", gallery.url);
    formData.append("video", gallery.image);
    const token = localStorage.getItem("token");
    setUploading(true);
    axios
      .post(`${SERVER_URL}/admin/add-videogallery`, formData, {
        headers: { "x-access-token": token },
      })
      .then((res) => {
              ...
              <div className="col-md-6 grid-margin stretch-card">
                <div className="card">
                  <div className="card-body">
                    <h6 className="card-title">Add Video Gallery</h6>
